/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: cfbb2dbb3ee6bd2524fc7270f0df98a5)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* books */;
		ASSETS: Fetcher;
	}
}
